...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxUndo = __webpack_require__(58);
	...
	var reducer = function reducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { msg: '♥ Curve Editor ♥' } : arguments[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('curve-editor', '<p> {this.opts.store.getState().present.msg} </p>', '', 'class="some-class"', function(opts) {
	"use strict";
